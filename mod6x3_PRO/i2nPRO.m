...
for rd = 0 : num_recording_devices-1
    ...
    for jj = 1 : recording_info.Probe_Count
        ...
        probe{probe_ctr+1}.port = paren(recording_info.Probe_Port{ii+rd}, jj);
        ...
        probe{probe_ctr+1}.type = paren(strtrim(split(recording_info.Probe_Ident{ii+rd}, ',')), jj);
        probe{probe_ctr+1}.type = probe{probe_ctr+1}.type{1};
