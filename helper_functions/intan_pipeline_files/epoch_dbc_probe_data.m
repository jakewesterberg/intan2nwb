...
[ml_data,config] = mlconcatenate('220915_LEO_glo_controlA.bhv2');
load('LEO_glo_DBC_data_0909_2022.mat')
folder_intan = dir('D:\Intan Recordings\LEO\GLO_DBC128\LEO_220915_112647');
...
low_pass_data_per_trial = nan(num_trials,20000,NUM_CHANNELS);
spike_data_per_trial = nan(num_trials,20000,NUM_CHANNELS);
...
for ii = 1:num_trials
    ...
    low_pass_data_per_trial(ii,1:difference_in_timing+1,:) = ...
        low_pass_data(:,start_timestamp:end_timestamp)';
    spike_data_per_trial(ii,1:difference_in_timing+1,:) = ...
...
save(string(subject_name)+"DBC_PROBE"+"_EPOCHED" +string(date_part),"event_code_time_stamps","eye_data_per_trial","low_pass_data_per_trial","spike_data_per_trial","event_codes","correct_trials","condition","-v7.3")
