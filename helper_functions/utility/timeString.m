function S = timeString(D,precision)
%timestr          String representation of time without date.   HH:MM:SS.SSSS
%
...
%   timestr(now)
%
% Display the current time, with 2 digits to the right of the decimal.
%   timestr(now,2)
